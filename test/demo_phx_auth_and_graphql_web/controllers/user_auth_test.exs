defmodule DemoPhxAuthAndGraphqlWeb.UserAuthTest do
  use DemoPhxAuthAndGraphqlWeb.ConnCase, async: true

  alias DemoPhxAuthAndGraphql.Accounts
  alias DemoPhxAuthAndGraphqlWeb.UserAuth
  import DemoPhxAuthAndGraphql.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DemoPhxAuthAndGraphqlWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DemoPhxAuthAndGraphqlWeb.Endpoint.subscribe(live_socket_id)
