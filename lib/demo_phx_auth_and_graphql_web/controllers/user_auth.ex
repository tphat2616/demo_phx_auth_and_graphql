defmodule DemoPhxAuthAndGraphqlWeb.UserAuth do
  import Plug.Conn
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      DemoPhxAuthAndGraphqlWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def require_authenticated_user_2(conn, _opts) do
    if conn.assigns[:current_user] do
      conn
    else
      conn
