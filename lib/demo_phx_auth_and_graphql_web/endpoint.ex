defmodule DemoPhxAuthAndGraphqlWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :demo_phx_auth_and_graphql
  ...
  plug Plug.Static,
    at: "/",
    from: :demo_phx_auth_and_graphql,
    gzip: false,
  ...
  plug DemoPhxAuthAndGraphqlWeb.Router
end
