defmodule DemoPhxAuthAndGraphqlWeb.Router do
  ...
  import DemoPhxAuthAndGraphqlWeb.UserAuth
  ...
  scope "/" do
    ...
    forward "/graphiql", Absinthe.Plug.GraphiQL,
            schema: DemoPhxAuthAndGraphqlWeb.Schema,
            interface: :simple,
            context: %{pubsub: DemoPhxAuthAndGraphqlWeb.Endpoint}
  end
  ...
  scope "/", DemoPhxAuthAndGraphqlWeb do
    ...
    post "/order/create", PageController, :test
