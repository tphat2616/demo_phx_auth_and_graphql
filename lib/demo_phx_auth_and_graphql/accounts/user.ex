defmodule DemoPhxAuthAndGraphql.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, DemoPhxAuthAndGraphql.Repo)
  ...
  """
  def valid_password?(%DemoPhxAuthAndGraphql.Accounts.User{hashed_password: hashed_password}, password)
